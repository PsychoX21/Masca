    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=128, validators=[django.core.validators.MinLengthValidator(8, 'Password must be at least 8 characters')])),
                ('profile_photo', models.ImageField(default='profile_photo/default-avatar.jpg', upload_to='profile_photo/')),
                ('Name', models.CharField(max_length=100)),
                ('DOB', models.DateField(default=datetime.date.today)),
                ('Phone', models.BigIntegerField(default=9999999999, validators=[django.core.validators.MaxValueValidator(9999999999), django.core.validators.MinValueValidator(1000000000)])),
